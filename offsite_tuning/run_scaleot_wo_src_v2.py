...
# ==========================================
# [CORE] ScaleOT Emulator Creation (NO SRC, 100% Harmonizer for non-adapters)
# ==========================================
def create_scaleot_emulator_no_src(full_model, importance_scores, harmonizers, budget_adapter=6, verbose=False):
    """
    MODIFIED: Removes SRC. All layers not selected as Adapters are replaced by Harmonizers.
    This perfectly matches FedRole's physical architecture for a fair Ablation study.
    """
    ...
    for chunk in chunks:
        ...
        # Sort by RL importance scores (descending)
        ...
        if rem_adapters > 0:
            ...
            # The rest in the chunk become Harmonizers (No SRC)
